...

{
  ...
  provider: {
    ...
    // auth: { type: 'profile', name: 'ccgate' },                              // reads `ant auth login` credentials, SDK refreshes
    // auth: { type: 'profile', name: 'ccgate', auto_login: true },            // [Beta] requires ant v1.5.0+ on PATH
  },
